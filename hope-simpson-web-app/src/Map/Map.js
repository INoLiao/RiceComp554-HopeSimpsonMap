  ...
  return (
    <div className="map-container container align-items-center">
      <div className="map-kanban rounded">
        ...
        <p className="lead">Inspired by Hope-Simpson's studies on influenza, we visualized COVID-19 daily confirmed cases in three different ways: <strong>COVID-19 Cases in the Four Latitude Zones</strong>, <strong>Region Comparisons</strong>, and <strong>North to South Slice of America</strong>. Our goal is to find whether the seasonally mediated mechanism takes effect on COVID-19 as it did on influenza.</p>
      </div>
      <TableauDashboard
