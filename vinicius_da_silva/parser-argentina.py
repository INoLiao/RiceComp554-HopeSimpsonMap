#Script to process the raw argentina dataset and generate data according to I-no's format
#Vini - 11/09/2020
...
def is_first_date(input, first): # yyy-mm-dd
        ...
        if y_in < y_f:
                return True
        elif y_in == y_f and m_in < m_f:
                return True
        elif y_in == y_f and m_in == m_f and d_in < d_f:
                return True
        else:
                return False
...
def is_last_date(input, last):
        ...
        if y_in < y_l:
                return True
        elif y_in == y_l and m_in < m_l:
                return True
        elif y_in == y_l and m_in == m_l and d_in < d_l:
                return True
        else:
                return False
